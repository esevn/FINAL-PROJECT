                                        ...
                                        <tbody
                                            ...
                                            <?php foreach ($posts_user as $posts): ?>
                                                <tr class="text-gray-700 dark:text-gray-400">
                                                    ...
                                                    <td class="px-4 py-3 text-sm">
                                                        <img class="w-40 h-20" src="../../public/img/konten/<?= $posts["attachment"] ?>" alt="">
                                                    </td>
                                                    <td class="px-4 py-3 text-sm">
                                                        <?= $posts["full_name"] ?>
                                                    </td>
                                                    ...
                                                    <td class="px-4 py-3">
                                                        <div class="flex items-center space-x-4 text-sm">
                                                            <a href="update-posts.php?id=<?= $posts["id_post"] ?>">
                                                                <button
                                                            ...
                                                            <a href="./../../service/delete-posts.php?id=<?= $posts["id_post"] ?>"><button onclick="confirmDelete(event, '<?= $posts['id_post'] ?>')" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                                aria-label="Delete">
                                                                <svg
                                                                    class="w-5 h-5" 
                                                                    aria-hidden="true"
        ...
        function confirmDelete(event, id) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    setTimeout(() => {
                        window.location.href = `./../../service/delete-posts.php?id=${id}`;
                    }, 1200)
                } else if (
